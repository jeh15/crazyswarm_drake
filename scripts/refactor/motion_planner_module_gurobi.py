...
class QuadraticProgram(LeafSystem):
    ...
    def build_optimization(self, context, event):
        ...
        # self.solver_options.SetOption(self.gurobi.solver_id(), "rho", 1e-02)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "eps_abs", 1e-03)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "eps_rel", 1e-03)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "eps_prim_inf", 1e-03)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "eps_dual_inf", 1e-03)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "max_iter", 8000)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "polish", True)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "polish_refine_iter", 6)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "warm_start", True)
        # self.solver_options.SetOption(self.gurobi.solver_id(), "verbose", False)
